        ...
        <div className="md:w-1/2 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-400 leading-6">
              ابزارکاشمر بازارگاه و فروشگاه آنلاینی در ایران و مستقر در خراسان رضوی ، شهرستان کاشمر است. این پلتفرم تجارت الکترونیکی طیف گسترده‌ای از کالاهای مصرفی را ارائه می‌دهد که شامل ابزارآلات متنوع با خدمات تحویل سریع است.
            </p>
          </div>
          ...
          <div className="grid bg-gray-700 rounded-2xl items-center p-6">
            <div className="flex items-center justify-between gap-6">
              ...
              <div className="space-y-2 text-white">
                <p>
                  <span className="font-bold"> تلفن:</span> 05155221455
                </p>
                <p>
                  <span className="font-bold"> آدرس:</span> کاشمر، بلوار فروتقه، بعد از امام‌رضا(ع)15
                </p>
                <p>
                  <span className="font-bold">ساعات پاسخگویی :</span> از ۸:۳۰ صبح تا ۲ ظهر ، از ۱۶ بعدازظهر تا ۹:۳۰ شب
                </p>
              </div>
            </div>
          </div>
