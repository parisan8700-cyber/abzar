...
export default function Karvash() {
  const [products, setProducts] = useState([]);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    Fetch.get("/api/products/category/karvash")
      .then((res) => {
      ...
      <div className="flex flex-wrap justify-center items-center content-center">
        ...
        <div className="flex items-center mb-6 w-full">
          ...
          <h2 className="px-4 text-2xl font-bold text-right whitespace-nowrap">
            <span className="text-gray-700">کارواش</span>{" "}
          </h2>

          {/* دکمه‌ها */}
          <div className="absolute left-1 lg:left-8 flex gap-2">
            <Link href="/shop/porforoush">
              <button
        ...
        <div className="w-[90%] md:w-full mx-auto px-3">
          <Swiper
            loop
