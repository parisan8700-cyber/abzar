            ...
            >
                ...
                <div className="w-full flex flex-col gap-2">
                    ...
                    <input
                        ...
                        className="rounded-xl px-4 py-3 w-full bg-white/40 text-black placeholder-gray-500 focus:ring-2 focus:ring-yellow-400 focus:outline-none transition-all duration-300"
                    />
                </div>
